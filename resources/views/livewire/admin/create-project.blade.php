<div>
    <form wire:submit.prevent="saveProject">
        ...
        <div class="mb-6 row">
            ...
            <div class="col-lg-8">
                <select id="departmentSelect" wire:model="selectedDepartments" multiple class="form-select form-select-lg form-select-solid" data-placeholder="Select departments" data-allow-clear="true">
        ...
        <div class="mb-6 row">
            ...
            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                <input type="date" wire:model="endDate" class="form-control form-control-lg form-control-solid" id="dateInput">
                @error('endDate')
                    <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
